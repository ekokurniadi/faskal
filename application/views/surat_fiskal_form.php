      ...
      <div class="col-12 col-md-12 col-lg-12">
        ...
        <form action="<?php echo $action; ?>" method="post" class="form-horizontal">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="no_seri" id="no_seri" placeholder="No Seri" value="<?php echo $no_seri; ?>" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="merktype_kendaraan" id="merktype_kendaraan" placeholder="Merktype Kendaraan" value="<?php echo $merktype_kendaraan; ?>" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="tahuncc_kendaraan" id="tahuncc_kendaraan" placeholder="Tahuncc Kendaraan" value="<?php echo $tahuncc_kendaraan; ?>" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="warna_kendaraan" id="warna_kendaraan" placeholder="Warna Kendaraan" value="<?php echo $warna_kendaraan; ?>" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="tanggal_bbn_kb" id="tanggal_bbn_kb" placeholder="Tanggal Bbn Kb" value="<?php echo $tanggal_bbn_kb; ?>" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="tanggal_pkb" id="tanggal_pkb" placeholder="Tanggal Pkb" value="<?php echo $tanggal_pkb; ?>" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="daerah_tujuan" id="daerah_tujuan" placeholder="Daerah Tujuan" value="<?php echo $daerah_tujuan; ?>" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="tanggal_swdkllj" id="tanggal_swdkllj" placeholder="Tanggal Swdkllj" value="<?php echo $tanggal_swdkllj; ?>" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="tanggal_akhir_berlaku_swdkllj" id="tanggal_akhir_berlaku_swdkllj" placeholder="Tanggal Akhir Berlaku Swdkllj" value="<?php echo $tanggal_akhir_berlaku_swdkllj; ?>" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="pejabat_uptd" id="pejabat_uptd" placeholder="Pejabat Uptd" value="<?php echo $pejabat_uptd; ?>" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="pejabat_jasaraharja" id="pejabat_jasaraharja" placeholder="Pejabat Jasaraharja" value="<?php echo $pejabat_jasaraharja; ?>" />
                </div>
              </div>
